<template>
   ...
   <div class="column is-4 is-offset-4">
    ...
    <h1 class="has-text-white-ter has-text-centered mb-4">สมัครใช้งาน</h1>
    ...
    <div class="box">
        <form class="has-text-grey-light" @submit="onSubmit">
            ...
            <b-field label="ชื่อ *" custom-class="has-text-white-ter">
              <b-input v-model="firstname" custom-class="login-input-bg has-text-white-ter is-normal"></b-input>
            </b-field>

            <b-field label="นามสกุล *" custom-class="has-text-white-ter">
              <b-input v-model="lastname" custom-class="login-input-bg has-text-white-ter is-normal"></b-input>
            </b-field>
            ...
            <button type="submit" class="button is-block is-success is-fullwidth mt-5">สมัคร</button>
        </form>
    </div>
